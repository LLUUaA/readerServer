...
--
-- Host: 127.0.0.1    Database: reader
-- ------------------------------------------------------
...
CREATE TABLE `search_record` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='search keyword record';
...
-- Dump completed on 2018-08-22 16:58:31
