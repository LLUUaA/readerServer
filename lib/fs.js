...
module.exports = {
    ...
    write(bookId, chapterNum, data, options = {}, append = false) {
        return new Promise((resolve, reject) => {
            try {
                ...
                this.write(bookId, chapterNum, data, options, append).then(resolve,reject)
            }
        })
    },
    /**
    ...
    chapterEnd(bookId, data, options = {}, append = false) {
        try {
            ...
            this.chapterEnd(bookId,data,options,append);
        }
    },
    ...
    checkFile(bookId, chapterNum) {
        return new Promise((resolve, reject) => {
            try {
                ...
                this.checkFile(bookId, chapterNum).then(resolve,reject)
            }
        })
    },
